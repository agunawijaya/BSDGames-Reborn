# `tetris` — BSDGames Reborn

> A spiritual-successor port of the classic BSD terminal Tetris.
...
A minimalist terminal Tetris from the classic BSDGames package. Seven tetrominoes fall into a 10×20 well. Clear rows, score points, and survive as long as you can while the game slowly accelerates toward impossibility.
