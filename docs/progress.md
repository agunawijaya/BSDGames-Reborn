...
| 🔴 Unclaimed | 0 |
| 🟡 Claimed | 0 |
| 🟠 In Progress | 36 (documentation phase; `dm` is docs-only with port skipped per ADR) |
| 🟢 Released | 8 (`robots`, `snake`, `worm`, `gomoku`, `wump`, `atc`, `trek`, `hangman` — `fancy-web` shipped) |
| ✨ Complete | 0 |
| **Total** | **43** |
